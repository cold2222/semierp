...
<link rel="stylesheet" href="sb/distribution_css/notice/noticeinsert.css">
							...
							<div class="bbs-content-body">
								<div class="bbs-content-bbs">
									<div class="bbs-main">
										...
										<textarea name="n_content" class="input-content" required="required" placeholder="内容を入力してください。" autocomplete="off"></textarea>
										<div class="filebox">
