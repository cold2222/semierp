	...
	<form action="TestwarehouseC" method="post">
		...
		<c:forEach var="t" items="${testWarehouse}">
			<div class="input-box input-container">
				...
				<div>
					<input name="record_count" value="${t.record_count}" readonly="readonly">
				</div>
				<div>
					<input name="p_si" value="${t.p_si}" readonly="readonly">
				</div>
				<div>
					<input name="in_warehouse_date" value="${t.in_warehouse_date}" readonly="readonly">
				</div>
				<div>
					<select name="warehouse_id">
						<option value="inchon_warehouse">인천창고</option>
						<option value="busan_warehouse">부산창고</option>
						<option value="mokpo_warehouse">목포창고</option>
					</select>
				</div>
				<div>
