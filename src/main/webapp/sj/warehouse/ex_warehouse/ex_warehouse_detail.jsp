...
<link rel="stylesheet" href="sj/warehouse_css/ex_warehouse_detail.css">
</head>
<body>

	<div class="contents">
		<div class="content-head">
			<div class="content-head-text">出庫確認</div>
		</div>
					...
					<div class="bbs-content-main">
						<div class="bbs-content-body">
							...
							<form action="ExWarehouseDetailC" method="post"
								...
								<c:forEach var="t" items="${exWarehouse}" varStatus="loop">
