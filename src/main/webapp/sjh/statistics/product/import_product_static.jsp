	...
	<div class="contents">
		...
		<div class="content-body">
			<div class="bbs-content1 bbs-content">
				...
				<div class="board">
					<div class="board-title">수입 상위</div>
					<div class="post">
				...
				<div class="board">
					<div class="board-title">수입 Cost 상위</div>
					<div class="post">
						...
						<div class="btn-area-mid">
							<c:if test="${currentPage != 1 }">
								<button class="idx-btn colorGold"
									onclick="location.href='ImportProductStatisticByMonthC?pageNo=${currentPage - 1}'">
									prev</button>
							</c:if>
							<c:forEach var="index" items="${indexList}">
								<c:if test="${index ne 0}">
									<button
										...
										onclick="location.href='ImportProductStatisticByMonthC?pageNo=${index}'">${index}</button>
								</c:if>
							</c:forEach>
